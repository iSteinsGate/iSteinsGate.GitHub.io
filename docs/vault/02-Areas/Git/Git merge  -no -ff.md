...
![](https://fastly.jsdelivr.net/gh/iSteinsGate/picture@master/assets/16765736497291676573648800.png)
...
merge的不同行为，向后看，其实最终都会将代码合并到master分支，而区别仅仅只是分支上的简洁清晰的问题，然后，向前看，也就是我们使用`reset` 的时候，就会发现，不同的行为就带来了不同的影响
  ...
  ![](https://fastly.jsdelivr.net/gh/iSteinsGate/picture@master/assets/16766036565091676603655643.png)

上图是使用 `merge --no-ff`的时候的效果，此时`git reset HEAD^ --hard` 的时候，整个分支会回退到 **dev2-commit-2**


![](https://fastly.jsdelivr.net/gh/iSteinsGate/picture@master/assets/16766035195091676603518588.png)
...
![](https://fastly.jsdelivr.net/gh/iSteinsGate/picture@master/assets/16766038525071676603851715.png)
