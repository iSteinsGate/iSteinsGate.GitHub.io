---
date created: 2023-04-19 10:06
date updated: 2023-04-19 10:06
tags:
 - Netty
from: net
---

[netty](https://mp.weixin.qq.com/s?__biz=MzU0OTk3ODQ3Ng==&mid=2247486735&idx=1&sn=0d3548e805f267e52676427a5e435d86&chksm=fba6e50cccd16c1abc7da64fb520dfd129625a6cf62f170b84e468aad1f7a8ee6e23bf5b29dc&scene=0&xtrack=1&key=579b4d06f77bd1e2ac9fe54450f30929bf814fcfcc1ef68612847fbbbb3384887ded210deb966a371aed530ef52b38ce86ca1f55429a9c98daca62739684114209602d66f82d6c32bd1b93149754c6ab&ascene=1&uin=MTkyODk2MDYxMg%3D%3D&devicetype=Windows+10&version=62070158&lang=zh_CN&exportkey=A6ftRY0ERyV0n3QmFlHaUK8%3D&pass_ticket=cU%2Fuva8PVUIec4O66%2BeYEoRl0mXesW9x0QhGfejLFpZ86jnjZoMZv%2BMoQna9Nk1L)
...
![](https://mmbiz.qpic.cn/mmbiz_png/MOwlO0INfQoLfibZ8XmcJmGNAuoJibo5UTbjNia0LZ9vnVnOr3bROIWY6ib7mPIJyTTJYpCwbeg0mhn4byRavXT8mw/640?wx_fmt=png)

_使用阻赛 I/O 处理多个连接_

为了解决上述的问题，推出了 NIO 的概念，也就是（Non-blocking I/O）。其中，Selector 机制就是 NIO 的核心。

当每次客户端请求时，会创建一个 Socket ChannJUt2kyISibSAIicZC6wxF0j6YLrfjzziaUTxA/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/MOwlO0INfQoLfibZ8XmcJmGNAuoJibo5UTxR1L4N4Iic1DfSHbib9VIdueBLiaIQRfqpAqVqJib9ybObQnicPI4wGEF5w/640?wx_fmt=png)

_构造函数中传入需要监听的端口号_

接下来就是服务的启动方法：

![](https://mmbiz.qpic.cn/mmbiz_png/MOwlO0INfQoLfibZ8XmcJmGNAuoJibo5UT5ibpiaJfNCHeh8q7t3Qx2fnJ1xx6qJuAplmmTC7wLcfupW6Hj7eiaLicYQ/640?wx_fmt=png)

_启动 NettyServer 的 Start 方法_
...
![](https://mmbiz.qpic.cn/mmbiz_png/MOwlO0INfQoLfibZ8XmcJmGNAuoJibo5UTFOTib2s9mXX4e6DCdn9dKM7Ak4iaLd50YKRK5ySTTTop85IgIKTIGuMQ/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/MOwlO0INfQoLfibZ8XmcJmGNAuoJibo5UTicJzNiagZv0MpYFy740fnGoVp58uFzicWLTBgr01DSfC2n1Jz5fCWRKfA/640?wx_fmt=png)

同样在客户端启动函数中包括以下内容：

![](https://mmbiz.qpic.cn/mmbiz_png/MOwlO0INfQoLfibZ8XmcJmGNAuoJibo5UTEFxzj9YuXzwXzxP8ymyZfAHIDO30lwG6o2Q9ptkicztniaDibhicaPhsaw/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/MOwlO0INfQoLfibZ8XmcJmGNAuoJibo5UT0ngk3mKoEwiax4RzjhUujneLY7ThicqiccdkAKOucSh6AVaVRTEiaur8Sw/640?wx_fmt=png)

例如 Channel 激活，客户端接受到服务端的消息，或者发生异常的捕获。

从代码结构上看还是比较简单的。服务端和客户端分别初始化创建监听和连接。然后分别定义各自的 Handler 处理对方的请求。

![](https://mmbiz.qpic.cn/mmbiz_png/MOwlO0INfQoLfibZ8XmcJmGNAuoJibo5UT0Vd7R9PSpSCXo1H8nISVvaMPRXMoc4SeqyXVUKKIVOnJmT559Zx5CQ/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/MOwlO0INfQoLfibZ8XmcJmGNAuoJibo5UTx98KW1qIMBlxPDKD7DcbwNItCibnHicL9R0qPE2ww65rJPESgsg9RcKg/640?wx_fmt=png)

_EventLoop 与 Channel 关系_
...
![](https://mmbiz.qpic.cn/mmbiz_png/MOwlO0INfQoLfibZ8XmcJmGNAuoJibo5UTg9QL2WyFfgjElbsEEJ0XWNYqibKAA6b1GpL1Npjn9G2A1pFerx4Z0Ag/640?wx_fmt=png)

_创建 EventLoopGroup_

EventLoopGroup 要做的就是创建一个新的 Channel，并且给它分配一个 EventLoop。

![](https://mmbiz.qpic.cn/mmbiz_png/MOwlO0INfQoLfibZ8XmcJmGNAuoJibo5UTsGtaGaOU9NImVFQVebibibibwqMAVaD5H7bwM6ibxibkkVvyryxehhRZCNw/640?wx_fmt=png)

_EventLoopGroup，EventLoop 和 Channel 的关系_
...
![](https://mmbiz.qpic.cn/mmbiz_png/MOwlO0INfQoLfibZ8XmcJmGNAuoJibo5UTneUCrJNgozW4AnU3VSTbZ566obQcv970fArddBia9rIQFZH1PgNibX2g/640?wx_fmt=png)

假设每次请求都会触发事件，而由 ChannelHandler 来处理这些事件，这个事件的处理顺序是由 ChannelPipeline 来决定的。

![](https://mmbiz.qpic.cn/mmbiz_png/MOwlO0INfQoLfibZ8XmcJmGNAuoJibo5UTuJs5cWXmPadGHyibgZ3woFMJNSk3Tj0SRwiaCEJlhAWrGuwg5DbQ3FLg/640?wx_fmt=png)

_ChannelHanlder 处理，出站 / 入站的事件_
...
![](https://mmbiz.qpic.cn/mmbiz_png/MOwlO0INfQoLfibZ8XmcJmGNAuoJibo5UTyEcIugpEBxA7nEOC7tUuWeePDSBHGPw1ia9uO6AfO0QtO4r2WjuR8mA/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/MOwlO0INfQoLfibZ8XmcJmGNAuoJibo5UTNfW71galiaQcU8wBoicsyYmyFJb2u4T7uJQ6GRJgH9tkGSBr30eZgWZg/640?wx_fmt=png)

ChannelHandlerContext 参数贯穿 ChannelPipeline，将信息传递给每个 ChannelHandler，是个合格的 “通讯员”。

![](https://mmbiz.qpic.cn/mmbiz_png/MOwlO0INfQoLfibZ8XmcJmGNAuoJibo5UTU4EqdHSMTgjUaFXsfSR4t9ZvzBGxZkolyJd9Ra0DC85XtOtgNG2icTA/640?wx_fmt=png)

_ChannelHandlerContext 负责传递消息_

把上面提到的几个核心组件归纳一下，用下图表示方便记忆他们之间的关系。

![](https://mmbiz.qpic.cn/mmbiz_png/MOwlO0INfQoLfibZ8XmcJmGNAuoJibo5UTVUOkqx5mmumSAMrOTPiaejqKAcjVyI4TNv9AFichnKoMHhAbTO5RIzzg/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/MOwlO0INfQoLfibZ8XmcJmGNAuoJibo5UTwKBb57nP8Sd2CSbvJQQ7wOkB89rsnTjrBWZBlf9o4ziauia7u1l20uFw/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/MOwlO0INfQoLfibZ8XmcJmGNAuoJibo5UTTsvibaibibPdtWq61vsPCt4MGPiaE2icXQw5ZRO3lmaicAZgcfAHH2bndiagA/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/MOwlO0INfQoLfibZ8XmcJmGNAuoJibo5UT6Hau3kciaKUbGh9BSrMat1PXAZjicSVJYYRyvDvAhgDl8ibcCfM3tlzVQ/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/MOwlO0INfQoLfibZ8XmcJmGNAuoJibo5UThibicGn0MWaq3cMIficD1e8mEIR0cBnkgOWMoxSX7lWZ2viaPr3QAWRQOQ/640?wx_fmt=png)

_Bootstrap 通过 bind 和 connect 方法创建连接_

服务端引导 ServerBootstrap，与客户端不同的是在 Bind（） 方法之后会创建一个 ServerChannel，它不仅会创建新的 Channel 还会管理已经存在的 Channel。

![](https://mmbiz.qpic.cn/mmbiz_png/MOwlO0INfQoLfibZ8XmcJmGNAuoJibo5UThFum28pzyzfQEr7DevxUQA90JFhOLoGl0icT48PImAKu2dY73SH8U2Q/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/MOwlO0INfQoLfibZ8XmcJmGNAuoJibo5UTPkRfE8u5C0jGRicCxmFLmltTKY7ZlrQBZGjSE6PkNtOJjsjMSECwAsQ/640?wx_fmt=png)

_ServerBootstrap 有两组 EventLoopGroup_
...
**如有收获，请划至底部，点击 “在看”，谢****谢****！**

![](https://mmbiz.qpic.cn/mmbiz_png/1J6IbIcPCLanG2nzjVZov1VibmPXR7lDibFjRdTvH1iaDz9ic4H3xRZCz7BM563rFFfvRukzX7uhOqXc8yDhEZqicFQ/640?wx_fmt=png)

欢迎长按下图关注公众号**石杉的架构笔记**

![](https://mmbiz.qpic.cn/mmbiz_jpg/1J6IbIcPCLbL5ObibXxibsicOibxlVzsNYiaKNhB0JU3obS7dZ1EHU4UXicJicnKpiaLxrcMCnTkybC8Xt76SZ8WGrZDeg/640?wx_fmt=jpeg)
